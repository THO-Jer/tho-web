...
const TEAM_IMAGES = ["/accion/03.png", "/accion/06.png", "/accion/09.png", "/accion/11.png"];
  ...
  return (
    <div className="min-h-screen bg-tho-bg">
      ...
      <main className="border-t border-slate-200" id="contenido">
        <section className="relative min-h-[58vh] overflow-visible text-white md:min-h-[68vh]">
          <div className="hero-media-fade pointer-events-none absolute inset-0">
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(108deg,rgba(15,23,42,0.08)_0%,rgba(15,23,42,0.38)_54%,rgba(15,23,42,0.7)_100%)]" />
          </div>
          ...
          <div className="relative mx-auto flex h-full min-h-[58vh] max-w-6xl items-end justify-end px-4 pb-16 pt-10 md:min-h-[68vh] md:pb-20">
            <div className="max-w-3xl text-right">
              ...
              <p className="mt-6 font-sans text-xl font-semibold leading-tight text-white md:text-[2.1rem]">
        ...
        <section className="mx-auto grid max-w-6xl gap-10 px-4 py-14 md:grid-cols-[1.1fr_0.9fr] md:py-20">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-justify text-base leading-relaxed text-slate-700 md:text-lg">
              THO se construye de los conocimientos acumulados de su equipo. Desde experiencias en
              desarrollo organizacional, participación pública, gestión de cambio, análisis social y
              estrategia. Este texto está a la izquierda porque a la derecha aparecen imágenes que se
              funden con el entorno. Esta sección se alimenta de imágenes en <strong>public/accion</strong>.
            </p>
          </div>

          <div className="grid grid-cols-2 gap-4">
            {TEAM_IMAGES.map((imagePath, idx) => (
              <figure
                key={imagePath}
                className={`overflow-hidden rounded-3xl border border-white/40 bg-white/20 shadow-[0_22px_45px_-30px_rgba(15,23,42,0.55)] ${
                  idx % 2 === 0 ? "translate-y-0" : "translate-y-6"
                }`}
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={imagePath} alt="Equipo THO en terreno" className="h-full w-full object-cover" />
              </figure>
            ))}
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-4 py-4 md:py-8">
          <div className="rounded-3xl border border-slate-200 bg-white/80 p-7 md:p-10">
            <p className="text-base leading-relaxed text-slate-700 md:text-lg">
              Los profesionales que se suman a esta consultora traen sus trayectorias, las cuales buscan
              sinergia bajo una misma tesis: <strong>Los procesos exitosos tienen a las personas al centro.</strong>
            </p>
            ...
            <p className="mt-6 text-base leading-relaxed text-slate-700 md:text-lg">
              En The Human Org reconocemos estas trayectorias y sabemos que la expertise que cada uno trae
              profundiza el propósito de la consultora.
            </p>
          </div>
        </section>

        <section className="mx-auto grid max-w-6xl gap-10 px-4 py-16 md:grid-cols-[0.95fr_1.05fr] md:py-20">
          <div className="grid grid-cols-2 gap-4">
            {TEAM_IMAGES.slice().reverse().map((imagePath, idx) => (
              <figure
                key={`thesis-${imagePath}`}
                className={`overflow-hidden rounded-3xl border border-white/40 bg-white/20 shadow-[0_22px_45px_-30px_rgba(15,23,42,0.55)] ${
                  idx % 2 === 0 ? "translate-y-5" : "translate-y-0"
                }`}
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={imagePath} alt="Consultoría THO" className="h-full w-full object-cover" />
              </figure>
            ))}
          </div>
          ...
          <div className="mx-auto mt-10 grid max-w-5xl gap-8 md:grid-cols-3">
            <article className="space-y-3 text-center md:text-left">
              ...
              <p className="text-sm leading-relaxed text-slate-700 md:text-base">
                Reconocemos que toda organización es un entramado de historias, expectativas y tensiones
                humanas. Diseñamos desde esa comprensión.
              </p>
            </article>
            ...
            <article className="space-y-3 text-center md:text-left">
              ...
              <p className="text-sm leading-relaxed text-slate-700 md:text-base">
                Creemos que las soluciones impuestas duran poco. Las soluciones construidas en conjunto
                transforman.
              </p>
            </article>
            ...
            <article className="space-y-3 text-center md:text-left">
              ...
              <p className="text-sm leading-relaxed text-slate-700 md:text-base">
                El entorno cambia. Las organizaciones cambian. Las comunidades cambian. Ajustar no es
                debilidad; es resiliencia estratégica.
              </p>
            </article>
          </div>

          <p className="mx-auto mt-8 max-w-3xl text-center text-base text-slate-700">
            Estos valores no son declarativos. Son criterios de decisión.
          </p>
        </section>

        <section className="mx-auto max-w-6xl px-4 pb-14 md:pb-20">
          <div className="rounded-3xl border border-slate-200 bg-white shadow-[0_24px_70px_-45px_rgba(15,23,42,0.55)]">
            <div className="relative overflow-hidden rounded-3xl p-7 md:p-10">
              <div
                className="pointer-events-none absolute inset-y-0 left-0 bg-[linear-gradient(120deg,#ffffff_0%,#f8fafc_72%,#e2e8f0_100%)]"
                style={{ width: `${thesisSplit}%` }}
              />
              ...
              <div className="relative z-10 grid gap-7 pt-6 md:grid-cols-2 md:gap-10">
                <article>
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-slate-700 md:text-base">
                    ...
                    intervenciones estratégicas técnicamente sólidas y humanamente sostenibles, asegurando
                    que cada proyecto fortalezca tanto a la organización como a su entorno.
                  </p>
                </article>
                ...
                <article>
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-slate-700 md:text-base">
                    Ser reconocidos como líderes y agentes de cambio en la industria de la asesoría en
                    Latinoamérica, por nuestro compromiso inquebrantable con la ética, la innovación y la
                    humanización, potenciando así el bienestar de las comunidades y el crecimiento
                    sostenible de las organizaciones que servimos.
                  </p>
                </article>
              </div>
            </div>
