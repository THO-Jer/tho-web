    ...
    <div className="min-h-screen bg-tho-bg">
      ...
      <main className="border-t border-slate-200" id="contenido">
        ...
        <section className="mx-auto grid max-w-6xl gap-10 px-4 py-14 md:grid-cols-[1.1fr_0.9fr] md:py-20">
          ...
          <div className="grid grid-cols-2 gap-4" data-reveal>
            {TEAM_IMAGES.map((imagePath, idx) => (
              <figure key={imagePath} className={`who-image-frame ${idx % 2 === 0 ? "translate-y-0" : "translate-y-4"}`}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
        ...
        <section className="mx-auto max-w-6xl px-4 py-4 md:py-8" data-reveal>
          <div className="rounded-3xl border border-slate-200/80 bg-white/75 p-7 backdrop-blur-sm md:p-10">
        ...
        <section className="mx-auto grid max-w-6xl gap-10 px-4 py-16 md:grid-cols-[0.95fr_1.05fr] md:py-20">
          <div className="grid grid-cols-2 gap-4" data-reveal>
            {TEAM_IMAGES.slice().reverse().map((imagePath, idx) => (
              <figure key={`thesis-${imagePath}`} className={`who-image-frame ${idx % 2 === 0 ? "translate-y-4" : "translate-y-0"}`}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div className="md:pl-8 md:text-right" data-reveal>
