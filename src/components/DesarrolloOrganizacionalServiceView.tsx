  ...
  return (
    <main className="esg-page bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <section className="esg-hero relative min-h-[84vh] overflow-hidden">
        ...
        <img src="/hero/5.png" alt="Equipo de liderazgo colaborando en una sesión de trabajo" className="absolute inset-0 h-full w-full object-cover object-center" />
        ...
        <div className="esg-reveal is-visible mx-auto max-w-6xl" data-reveal-id={revealItems[5]}>
          <div className="grid gap-5 md:grid-cols-[1fr_0.95fr] md:items-start">
            ...
            <aside className="relative md:-mt-4 md:-mr-4">
              <div className="rounded-3xl border border-indigo-300/70 bg-[linear-gradient(160deg,#fff7ed_0%,#ffedd5_65%,#fdba74_100%)] p-6 shadow-xl shadow-indigo-900/10 dark:border-indigo-400/30 dark:bg-[linear-gradient(160deg,rgba(15,23,42,0.96)_0%,rgba(67,56,202,0.65)_100%)]">
          ...
          <div className="rounded-[2rem] bg-slate-950 px-6 py-10 text-white ring-1 ring-slate-800 md:px-8 md:py-12">
            <div className="grid gap-8 md:grid-cols-[0.95fr_1.05fr] md:items-start">
              ...
              <form onSubmit={onContactSubmit} className="grid gap-3 rounded-3xl bg-slate-900/70 p-5 ring-1 ring-white/10">
                ...
                {contactStatus === "ok" ? <p className="text-sm text-indigo-200">Gracias, te contactaremos pronto.</p> : null}
      ...
      {open ? (
        <div className="fixed inset-0 z-[90] grid place-items-center bg-slate-900/70 px-4 backdrop-blur-sm" role="dialog" aria-modal="true">
          <div className="w-full max-w-lg rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-700 dark:bg-slate-900">
            ...
            {brochureStatus === "ok" ? <p className="mt-3 text-sm text-indigo-700">Descarga iniciada. También registramos tu solicitud.</p> : null}
