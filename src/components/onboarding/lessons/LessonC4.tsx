 ...
 *
 * Estructura:
 *  1. Premisa (brief ideal pero no siempre contratado; rol activo del PO).
 *  2. Callout: brief general + briefs específicos por pieza.
 *  3. Criterios mínimos de inicio (tabla ítem + por qué).
 *  4. Señales de alerta (BulletSection callout con closing sobre el PO).
 *  5. Síntesis.
 */
export function LessonC4({
  ...
  return (
    ...
    >
      ...
      {/* Callout brief general + específicos */}
