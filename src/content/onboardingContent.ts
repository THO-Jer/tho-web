...
export const defaultOnboardingUnits: OnboardingUnit[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "B3 — Pricing en THO: se cobra en UF por protección inflacionaria, estabilidad presupuestaria, estándar de servicios profesionales en Chile y claridad contractual. La estructura de precios depende de profundidad del servicio, tiempo requerido, nivel de responsabilidad, exposición al riesgo y dedicación operativa. Cuenta clave implica compromiso mensual relevante y exigencia real de capacidad interna.",
      "B4 — Diagnóstico de cliente (calidad antes que volumen): THO no busca cualquier cliente, busca cliente compatible. Preguntas mínimas: liderazgo claro, disposición a documentar, aceptación de trazabilidad, foco en método (vs resultado rápido), responsable interno definido. Si no hay condiciones mínimas, aumenta riesgo operativo, desgaste y riesgo reputacional. Decir 'no' también es una decisión profesional en THO.",
      "B5 — CRM en THO (corazón operativo): componente comercial (pipeline, etapas, historial, dashboard de cierres, conversión, tiempo de cierre, estado de cuentas ticket/cuenta clave) y componente financiero/contable (facturas emitidas/recibidas, boletas de honorarios y gastos menores, dashboard financiero, estado de resultados, soporte a contabilidad y base para operación renta). Regla base: si no está registrado, no existe.",
